...
import { ChooseSituationContent, ExerciseStoryContext } from '@/lib/db/types';

interface Props {
    question: {
        content: ChooseSituationContent;
    };
...
export default function ChooseSituationQuestion({ question, storyContext, onAnswer, disabled }: Props) {
    ...
    const phrase = content.phrase || (content as any).text || (content as any).expression || '';
    const questionText = content.question || (content as any).prompt || 'When would you use this phrase?';
    ...
    return (
        <div className="h-full flex flex-col py-8 font-sans">
            ...
            {/* Phrase Card */}
            <div className="border border-neutral-200 shadow-[4px_4px_0px_0px_rgba(0,0,0,0.04)] p-6 mb-10 text-center">
