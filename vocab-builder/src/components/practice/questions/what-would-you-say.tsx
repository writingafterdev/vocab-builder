...
import { WhatWouldYouSayContent, ExerciseStoryContext } from '@/lib/db/types';

interface Props {
    question: {
        content: WhatWouldYouSayContent;
    };
...
export default function WhatWouldYouSayQuestion({ question, storyContext, onAnswer, disabled }: Props) {
    ...
    const context = content.context || (content as any).situation || (content as any).scenario || '';
    ...
    return (
        <div className="h-full flex flex-col py-8 font-sans">
            ...
            >
                ...
                <p className="text-base text-neutral-800 leading-relaxed font-serif mb-4">
                    &ldquo;{context}&rdquo;
                </p>
                {content.prompt && (
